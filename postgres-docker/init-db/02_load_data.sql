...
COPY work_orders (
    work_order_id, work_order_type, ac_model, aircraft_description, mel_detail_id, mel_code, mel_chapter_code,
    ...
    opco_code, workstep_text, action_text, parts_text, transfer_reason_text
)
